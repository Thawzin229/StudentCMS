    ...
    <div class="min-h-full">
        ...
        <main>
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                <div class="flex">
<div  style="width: 30%" class="p-6 text-center mx-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Admin</h5>
    </a>
    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Total({{$admin}})</p>
</div>
...
<div  style="width: 30%" class="p-6 text-center mx-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Total({{$user}})</p>
</div>

<div  style="width: 30%" class="p-6 text-center mx-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Students</h5>
    </a>
    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Total({{$student}})</p>
    <a href="/user/students" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        View more
